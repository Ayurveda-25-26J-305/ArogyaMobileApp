...
export default function QAScreen() {
  const features = [
    ...
    'Answers from Charaka Samhita',
    'Dosha & treatment queries',
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.iconWrap}>
        <Ionicons name="help-circle" size={80} color="#558b2f" />
      </View>
      <Text style={styles.title}>Intelligent Q&A System</Text>
      <Text style={styles.subtitle}>
        Ask anything about Ayurveda. Powered by classical texts
        and fine-tuned NLP models for accurate answers.
      </Text>
      ...
      <View style={styles.card}>
        ...
        {features.map((f, i) => (
          <View key={i} style={styles.featureRow}>
            <Ionicons name="checkmark-circle-outline" size={18} color="#558b2f" />
      ...
      <View style={styles.devCard}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.devName}>Fernando K P M R A</Text>
          <Text style={styles.devId}>IT22897176</Text>
          <Text style={styles.devModule}>Intelligent Q&A Module</Text>
        </View>
      </View>
