  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.iconCircle}>
        <Ionicons name="chatbubbles" size={64} color="#2d5016" />
      </View>
      <Text style={styles.title}>Q&A Assistant</Text>
      <Text style={styles.subtitle}>Intelligent Ayurvedic Question Answering</Text>
      
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Coming Features</Text>
        {[
          'Natural language question processing',
          'Ayurvedic knowledge base search',
      ...
      <View style={styles.devCard}>
        ...
        <Text style={styles.devModule}>Intelligent QA over Ayurvedic Medicine Module</Text>
      </View>
