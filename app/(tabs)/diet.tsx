  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.iconCircle}>
        <Ionicons name="nutrition" size={64} color="#2d5016" />
      </View>
      <Text style={styles.title}>Dietary Planning</Text>
      <Text style={styles.subtitle}>Personalized Ayurvedic Meal Recommendations</Text>
      
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Coming Features</Text>
        {[
          'Dosha-specific diet plans',
          'Disease-based meal suggestions',
